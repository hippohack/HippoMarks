...
ActiveRecord::Schema.define(version: 2020_02_29_135617) do
  ...
  create_table "patreon_tokens", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
